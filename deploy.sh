...
cd js
cat tools.js tests.js ray.js laser.js canvasstate.js curves.js elements.js box.js circularplanoconvex.js circularplanoconcave.js coordinates.js info.js main.js > all.js
